      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Add and configure cameras</p>
              </div>
            </a>
            ...
            >
              ...
              <div>
                <p className="font-medium text-gray-900">Heat Map</p>
                <p className="text-sm text-gray-600">Real-time crowd density</p>
              </div>
            </a>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Dashboard Active</h3>
            <p className="text-gray-600">
              Camera integration, YOLO detection, and real-time monitoring are operational.
            </p>
          </div>
        </div>
      </div>
